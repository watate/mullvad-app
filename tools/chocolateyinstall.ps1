...
#$pgpPublicKey = "$toolsDir\MullvadVPN-2021.2.exe.asc"
...
$packageArgs = @{
  ...
  fileType      = 'exe'
  url64bit      = 'https://mullvad.net/media/app/MullvadVPN-2021.2.exe'

  checksum64    = 'a96483eecbc58da8a8dc696946300a5d6c4e8fe05f4d38ea264b41db711a77dc'
